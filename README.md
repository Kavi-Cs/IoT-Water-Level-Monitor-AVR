...
## 9. PROJECT MEDIA & DEMONSTRATION

To provide a comprehensive view of the system's physical implementation and real-time operational capabilities, the following visual documentation and video demonstrations are included.

### 9.1 Hardware Assembly & Final Enclosure

The hardware was designed for robustness and ease of monitoring. The following images detail the internal PCB layout alongside the fully sealed external enclosure and live display.

| Internal PCB Assembly | Final Weatherproof Enclosure |
| :---: | :---: |
| <img src="inside_pcb.jpg" width="400" alt="Inside PCB"> | <img src="outside_final.jpg" width="400" alt="Outside Final Product"> |
| *Figure 9.1: Internal component wiring and custom PCB layout.* | *Figure 9.2: Sealed IP-rated enclosure ready for deployment.* |

| Live LCD Status Display | Additional System View |
| :---: | :---: |
| <img src="outside_lcd.jpg" width="400" alt="LCD Display"> | <img src="photo_4.jpg" width="400" alt="System Setup"> |
| *Figure 9.3: Real-time sensor and system status interface.* | *Figure 9.4: Additional system deployment view.* |

### 9.2 System Demonstrations

The operational behavior of the prototype, including sensor polling, threshold detection, and alert generation, is demonstrated in the videos below.

**Demonstration 1: Internal Component Operation & Logic Flow**
> This video showcases the internal hardware functioning in real-time, demonstrating the MCU interacting with the ESP-01, SIM800L, and local SD card logging mechanisms.

<video src="inside_video.mp4" controls="controls" width="100%"></video>

**Demonstration 2: Finalized Product & Alert Triggering**
> This demonstration highlights the fully enclosed system reacting to simulated flood conditions, displaying the transition into danger thresholds, local alarm activation, and remote alert dispatching.

<video src="final_product_video.mp4" controls="controls" width="100%"></video>
